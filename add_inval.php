...
<div>
  ...
  <div class="container" style="background:white">
        ...
        <div style="width:100%" >
          ...
          <form name="myForm" action="accept_add_inval.php" method="POST" onsubmit="return validateForm()">
            <div class="form-group row" style="margin-left:10%;margin-right:10%" id="fname_div">
              ...
              <div class="col-10">
                <input class="form-control" type="text" id="fname" name="fname" placeholder="ชื่อ" onkeyup="clean_not_char(this)" onkeydown="clean_not_char(this)">
              </div>
          ...
          <div class="form-group row" style="margin-left:10%;margin-right:10%" id="lname_div">
            ...
            <div class="col-10">
              <input class="form-control" type="text" id="lname" name="lname"  placeholder="สกุล" onkeyup="clean_not_char2(this)" onkeydown="clean_not_char2(this)">
            </div>
            <label class="col-2 col-form-label" id="al" style="visibility: hidden;"></label>
    ...
    <div class="form-group row" style="margin-left:10%;margin-right:10%" id="tel_div">
     ...
     <div class="col-10">
      <input class="form-control" type="tel" id="tel" name="tel" onkeyup="validatetel(this)" onkeydown="validatetel(this)">
    </div>
    <label class="col-2 col-form-label" id="al" style="visibility: hidden;"></label>
