        ...
        <div class="col-lg-12">
          <div style="width:100%" >
            ...
            <form name="myForm" action="accept_adddata.php" method="post" onsubmit="return validateForm()">
              ...
              <div class="form-check form-group row" style="margin-left:10%">
                ...
                <label class="form-check-label" style="margin-left:2%">
                  <input class="form-check-input" type="radio" name="BloodGroup" id="inlineRadioAB" value="AB" checked=""> AB
                </label>
                <label class="form-check-label" style="margin-left:2%">
              ...
              <div class="form-group row" style="margin-left:10%;margin-right:10%">
                ...
                <div class="col-10">
                  <input class="form-control" type="number" id="SYS" name="SYS" placeholder="SYS" min="1" max="999" value="119">
                  <input class="form-control" type="number" id="DIA" name="DIA"  placeholder="DIA" min="1" max="999" value="78">
                </div>
              </div>
              <div class="form-group row" style="margin-left:10%;margin-right:10%">
              ...
              <div class="col-10">
                <input class="form-control" type="number" id="height" name="height" placeholder="meter" min="1" max="999" value="49">
              </div>
            </div>
            <div class="form-check form-group row" style="margin-left:10%">
          ...
          <div class="form-check form-group row" style="margin-left:10%" id="dsub_DIV">
            ...
            <div class="form-check form-group row" style="margin-left:10%">
              ...
              <label class="form-check-label" style="margin-left:2%">
                <input class="form-check-input" type="radio" name="Drink" id="drink1" value="1" checked=""> 1-2
              </label>
              <label class="form-check-label" style="margin-left:2%">
            ...
            <div class="form-check form-group row" style="margin-left:10%">
              <label class="form-check-label"  style="margin-left:5%">
                <input class="form-check-input" type="radio" name="Smoke" id="Smoke0" value="0" checked=""> ไม่สูบ
              </label>
              <label class="form-check-label" style="margin-left:2%">
            ...
            <div class="form-check form-group row" style="margin-left:10%">
              <label class="form-check-label"  style="margin-left:5%">
                <input class="form-check-input" type="radio" name="exercise" id="exercise0" value="0" onclick="disabled_TE()" checked="">ไม่ได้ออกกำลังกาย
              </label>
              <label class="form-check-label" style="margin-left:2%">
            ...
            <div class="form-check form-group row" style="margin-left:10%">
              <label class="form-check-label"  style="margin-left:5%">
                <input class="form-check-input" type="checkbox" id="homearea1" name="homeArea1" value="1" aria-label="..." checked="">มีแอ่งน้ำ หรือ พื้นที่น้ำขัง
              </label>
              <label class="form-check-label" style="margin-left:2%">
