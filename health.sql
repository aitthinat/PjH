...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2017 at 02:08 PM
...
INSERT INTO `health_info` (`Hcid`, `Year`, `Date_of_Health`, `Weight`, `Height`, `Blood_group`, `Environment`, `Disability`, `Intolerance`, `Food_allergies`, `BP_SYS`, `BP_DIA`, `Chronic_Disease`, `Sex`, `BOS`, `BOA`, `Exercise`, `Ehours`) VALUES
('3401343210123', 2013, '2013-02-12', 50, 160, 'A', 'มีแหล่งน้ำ', '0', '0', 'ปลาหมึก', 140, 90, '0', 'F', 2, 2, 0, 0),
('3400123345510', 2014, '2014-11-30', 63, 150, 'B', 'ใกล้แหล่งอุตสาหกรรม', '0', 'แอสไพริน', '0', 130, 85, 'เบาหวาน', 'M', 0, 1, 0, 0),
('1120911201921', 2015, '2015-01-08', 45, 152, 'O', 'มีแหล่งน้ำ, ใกล้แหล่งอุตสาหกรรม', 'หูหนวก', '0', '0', 120, 81, '0', 'F', 3, 0, 0, 0),
('1409901496220', 2016, '2016-06-17', 52, 165, 'A', 'มีแหล่งน้ำ,ใกล้แหล่งอุตสาหกรรม', 'ตาบอด', 'พาราเซตามอล', 'กุ้ง', 120, 80, 'ทาลัสซีเมีย, เบาหวาน', 'M', 0, 0, 0, 0);
...
('1120911201921', 'นางสาว', 'จิรวดี', 'ศรีสุพรรณ์', '0000-00-00', '0654494959', 5, 3, 3, '4', '20010549965'),
('1409901496220', 'นาย', 'อิทธิณัฐ', 'สุริยสมบูรณ์', '0000-00-00', '0620354897', 5, 3, 1, '3', '12345678911'),
('3400123345510', 'นาง', 'สมิงดำ', 'ลำลูกกา', '0000-00-00', '0823324344', 2, 1, 2, '2', '53050998965'),
('3401343210123', 'นาย', 'สมาน', 'สานใย', '0000-00-00', '0811122234', 0, 2, 2, '1', '56130123965');
